...
- feat(home): the Home page is now a personalised to-do hub — it greets you by name with the current date/time and, when every week of the month is submitted, shows an "all caught up" hero card with a stat strip (weeks submitted, hours logged this month, leave days left) and quick links to Time entry, Timesheets, and Leave overview
